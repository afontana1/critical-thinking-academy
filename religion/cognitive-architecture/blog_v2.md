...
- [Introduction: The predator behind the bush](#introduction)
- [Part I — Evolution, reliability, and divine intentions](#part-i)
  - [1. Evolution, truth, and cognitive reliability](#chapter-1)
  - [2. Divine intentions and the limits of reliability](#chapter-2)
- [Part II — The problem of cognitive design](#part-ii)
  - [3. Evolutionary constraints and adaptive error](#chapter-3)
  - [4. Consequential mistakes and cognitive self-correction](#chapter-4)
  - [5. The counterfactual cognitive-design laboratory](#chapter-5)
  - [6. The unequal distribution of cognitive opportunities](#chapter-6)
  - [7. Omniscience, omnipotence, and perfect goodness](#chapter-7)
  - [8. Theological responses and the demands of explanation](#chapter-8)
- [Part III — Recognizing revelation](#part-iii)
  - [9. From ordinary cognition to recognizing revelation](#chapter-9)
  - [10. Competing revelations and religious disagreement](#chapter-10)
  - [11. Geography and unequal access to religious evidence](#chapter-11)
  - [12. The *sensus divinitatis* and divine assistance](#chapter-12)
  - [13. Freedom, faith, and divine hiddenness](#chapter-13)
- [Part IV — Divine psychology and the limits of explanation](#part-iv)
  - [14. The knowability dilemma](#chapter-14)
- [References](#references)

<a id="section-i"></a>
<a id="introduction"></a>
## Introduction: The predator behind the bush
...
The consequences of her decision are asymmetric. If she flees when no predator is present, she wastes energy and perhaps abandons an opportunity to obtain food. If she remains when a predator is present, the consequences could be fatal. Under these conditions, a defensive system that frequently responds to harmless stimuli may nevertheless provide an adaptive advantage. An organism need not correctly identify every stimulus to make decisions that improve its prospects of survival; importantly, a false alarm in action does not itself show that the organism held a false belief.
...
Fales's objection opens three connected questions. First, what reasons does evolution give us for expecting minds that are generally reliable? Second, even if a perfectly good God would value reliability, why would God choose or permit minds with our particular limitations and their foreseeable consequences? Third, if a theological model holds that God wants people to recognize a particular revelation, how are these minds and their unequal opportunities for acquiring evidence suited to that purpose? These questions concern not simply whether humans sometimes err, but what an omniscient, omnipotent, perfectly good creator's independently justified purposes would lead us to expect. The inquiry begins with Plantinga's argument and Fales's response, then turns to cognitive design and, finally, the recognition of revelation.

<a id="part-i"></a>
## Part I — Evolution, reliability, and divine intentions

To assess what divine design explains, we must first establish what the evolutionary debate does—and does not—say about the reliability of our faculties.

<a id="chapter-1"></a>
### 1. Evolution, truth, and cognitive reliability
...
#### Fales’s response: why evolution can favor reliable cognition
...
<a id="chapter-2"></a>
### 2. Divine intentions and the limits of reliability

<a id="section-iv"></a>

#### Would God want reliable minds?

Fales's second challenge shifts attention from what God *could* create to what we have grounds to expect God *would* create. Even if God possesses the power to produce reliable cognitive faculties, divine ability alone does not establish a particular intention. What, then, justifies expecting God to give human beings generally reliable minds?
...
| --- | --- |
| General accuracy | Do the faculties produce substantially more true than false beliefs in a relevant range? |
| Domain-specific reliability | In which environments and subjects do those faculties work well? |
| Confidence calibration | Does confidence track the evidence or the chance of being right? |
| Practical rationality | Does an agent decide appropriately given information, aims, and uncertainty? |
| Epistemic opportunity | Does a person have access to the evidence and corrective resources needed to exercise those faculties? |

The first four distinctions are developed below; the fifth becomes central in the discussion of cognitive opportunity. These dimensions interact, but their questions must not be conflated.
...
<a id="part-ii"></a>
## Part II — The problem of cognitive design

The question now shifts from whether our faculties are generally reliable to why they have this particular combination of capabilities, vulnerabilities, and opportunities for correction.

<a id="chapter-3"></a>
### 3. Evolutionary constraints and adaptive error

<a id="section-vi"></a>

Evolutionary theory explains cognitive limitations by identifying the processes and constraints that shaped them. Natural selection sometimes yields imperfect outcomes, but the more informative question is *why* organisms possess the particular characteristics they do. Those mechanisms matter when we ask which constraints apply to evolutionary processes and which, if any, would constrain a creator possessing the classical divine attributes.
...
#### Threat detection: when false alarms can be adaptive

Return to the early human who hears movement behind a bush. She must decide whether to flee or remain, despite uncertainty about whether a predator is present. The consequences of her decision depend on both the actual state of the environment and the action she chooses. The situation can be represented by a simple decision matrix:
...
Because the cost of missing a genuine threat can greatly exceed the cost of a false alarm, the threshold for defensive behavior can be very low. A system can therefore respond to many harmless stimuli while still performing effectively under the relevant conditions.

This is the central insight of Randolph Nesse's smoke detector principle: natural selection can favor defensive systems that generate frequent false alarms when the response is relatively inexpensive and the danger is severe ([Nesse, 2005](#ref-nesse)). Such a pattern can be adaptive without implying that every false alarm is beneficial or that the system is optimally regulated.

The example also exposes an important distinction between belief accuracy and decision quality. An organism may reasonably flee because a predator is sufficiently likely, even if none is present. That unnecessary flight need not involve a false belief: the organism might correctly judge that a threat is possible and act prudently given the costs of error. A mistaken belief about the predator and a rational precaution under uncertainty are different phenomena.

A false alarm is therefore not automatically evidence of defective cognition: a system that waits until danger is virtually certain could perform considerably worse than one that sometimes responds unnecessarily. Nevertheless, the rule is effective *given* uncertainty, incomplete information, limited processing time, and the relative costs of alternative actions; its effectiveness does not establish that those conditions are unavoidable or desirable. An organism with more accurate threat detection might avoid unnecessary defensive responses without becoming more vulnerable to genuine predators, although greater accuracy could involve costs or functional trade-offs. Evolutionary theory helps explain why such improvements may not arise through natural selection, but it does not independently establish that an omnipotent creator could not provide them. The philosophical distinction is between a decision rule that is adaptive under specified constraints and a cognitive architecture whose constraints still require explanation.

<a id="chapter-4"></a>
### 4. Consequential mistakes and cognitive self-correction

#### Medical diagnosis: when limitations can cause harm

Medical diagnosis presents a different cognitive problem: clinicians must integrate symptoms, patient histories, examination findings, and test results while distinguishing among competing explanations. The information is frequently incomplete, and many conditions share similar features. Clinicians must therefore reason under uncertainty, sometimes while facing substantial time pressure.
...
These tools do not make cognition perfect. They do, however, raise the question of why our architecture requires correction in the first place, particularly when failures can have serious consequences.
...
Whether such an architecture could be realized without sacrificing other important goods remains a substantive question. The mere ability to describe an improvement does not establish its feasibility, and a more capable cognitive system might involve trade-offs that are not immediately apparent. Nevertheless, our development of corrective methods provides a reason to investigate these alternatives rather than assume that the actual architecture represents the only possible arrangement compatible with intellectual development.

Correction also has a distributive dimension: access to reliable information, education, scientific instruments, and opportunities for intellectual development is not uniform across human lives. Some individuals can benefit from sophisticated methods of error correction, while others encounter circumstances in which those resources are unavailable. The significance of this unequal access will become especially important when we examine the distribution of cognitive opportunities and the conditions under which people attempt to identify religious truth.
...
<a id="chapter-5"></a>
### 5. The counterfactual cognitive-design laboratory

<a id="section-ix"></a>

Our ability to correct some cognitive weaknesses suggests that the present architecture is not the only conceivable arrangement supporting knowledge, learning, and meaningful action. Yet conceivability alone does not show that a less harmful architecture could actually be created. A counterfactual approach asks how specific changes might affect belief formation and decision-making, including the goods preserved, errors reduced, and trade-offs introduced. The relevant question is not whether God could have created omniscient human beings, but whether an omnipotent creator could have provided finite creatures with somewhat different capacities that would reduce substantial suffering while preserving meaningful freedom, intellectual development, and other goods.

#### What would a better cognitive architecture look like?

| Possible change | Potential benefit | Important unresolved trade-off |
| --- | --- | --- |
| Better confidence calibration | Less unwarranted certainty and better recognition of when to investigate | Whether and how it changes other cognitive functions |
| Stronger reasoning about consequences | Better recognition of alternatives and foreseeable harms | Costs of additional processing or interference with other capacities |
| More accurate social interpretation | Fewer misunderstandings based on available evidence | Preserving privacy and autonomy without introducing new costs |

These are candidates for analysis, not established improvements that can be obtained without sacrifice. Each must be assessed for possibility, consequences, and independently supported trade-offs.
...
<a id="chapter-6"></a>
### 6. The unequal distribution of cognitive opportunities
...
<a id="chapter-7"></a>
### 7. Omniscience, omnipotence, and perfect goodness

<a id="section-xi"></a>

Our faculties are generally reliable yet limited in particular domains; some vulnerabilities contribute to serious suffering, and opportunities for correction are unequally distributed. Evolutionary theory helps explain how these conditions arise under historical and biological constraints. Classical perfect-being theism introduces a different question: what does the actual arrangement imply when considered alongside God’s knowledge, power, and goodness?
...
<a id="chapter-8"></a>
### 8. Theological responses and the demands of explanation
...
A further distinction concerns freedom and the power to inflict harm. Even if significantly free creatures must be able to choose wrongly, it does not immediately follow that they must be able to produce every harmful consequence associated with their choices. A creator might conceivably permit an agent to make a wrongful decision while limiting the damage that decision can cause. Philosophical discussions of free-will theodicies accordingly distinguish the value of freedom itself from the value, if any, of possessing the capacity to cause serious harm ([“The Problem of Evil”](#ref-evil)). Applied to cognition, the question is whether the goods associated with freedom require not only the possibility of mistaken choice, but the particular vulnerabilities that make serious mistakes foreseeable. The free-will response may therefore explain an important feature of moral agency without, by itself, explaining why God would choose our actual cognitive architecture.
...
The problem is particularly significant when severe suffering prevents rather than facilitates intellectual or moral development. Some individuals may benefit from confronting difficulty, while others encounter conditions that deprive them of the opportunity to learn, develop, or exercise their capacities. The value of soul-making therefore does not automatically explain the actual distribution or severity of suffering ([“The Problem of Evil”](#ref-evil)). A more developed soul-making explanation would need to identify why the relevant goods require this particular cognitive architecture and why less harmful alternatives would be insufficient.
...
However, the distinction between finite and infinite knowledge does not determine how capable finite cognition must be. There is an enormous conceptual distance between ordinary human reasoning and omniscience. A creature could possess substantially greater processing capacity, better perception, or more reliable inferential faculties while remaining finite in every relevant respect. Consequently, creaturely finitude can explain why human beings might lack unlimited knowledge without automatically explaining why they possess our particular limitations. A related proposal is that excessive cognitive capacity would make creatures too much like God, undermining humility, dependence, or some appropriate relationship between creator and creation.

Such an explanation might be developed within a particular theological framework, but it requires additional premises. Why would greater intelligence undermine humility? Why would a more accurate understanding of the world diminish a creature's dependence on God? And why would God prefer a particular degree of cognitive limitation if that limitation predictably contributes to substantial suffering? These questions do not establish that the proposal is false. They identify the further account of divine purposes required for it to possess explanatory force.
...
These difficulties do not establish that every Fall-based account is incoherent. They show that appealing to sin introduces a more specific theological model whose historical, metaphysical, and explanatory assumptions require independent support. The account becomes especially important later in this essay, when we examine whether purportedly damaged religious cognition can explain disagreement concerning divine revelation.

#### What would count as a successful explanation?

The responses considered here identify several possible goods associated with human cognitive limitations: meaningful freedom, intellectual development, creaturely finitude, an autonomous creation, and a theological account of the consequences of sin. They are not mutually exclusive. A theist could maintain that several such considerations jointly explain the world we observe. Nor is it inherently illegitimate to supplement a broad theological hypothesis with additional commitments about divine purposes.

The explanatory question is what those commitments establish. A response may show that a particular limitation is compatible with God's goodness without establishing that the limitation was necessary, preferable, or probable given God's attributes. A more ambitious explanation would identify why relevant alternatives are unavailable or would sacrifice goods sufficient to justify the actual arrangement.

This distinction returns us to Fales's original objection. Establishing that God could intend to create reliable minds does not establish that God probably would. Likewise, establishing that God could have a reason for permitting cognitive limitations does not establish that those limitations are what theism leads us to expect. The central issue is whether the proposed divine purposes are independently justified and sufficiently specific to distinguish our actual cognitive architecture from plausible alternatives.
...
The next application concerns revelation: if identifying a divine message matters, what opportunities and faculties would a creator be expected to provide? The broader consequences of uncertainty about divine intentions will return in the concluding knowability dilemma.

<a id="part-iii"></a>
## Part III — Recognizing revelation

A further application arises when a theological model holds that recognizing God or a particular revelation matters. General success in ordinary environments alone does not establish how reliably we can receive, authenticate, and interpret divine communication.

<a id="chapter-9"></a>
### 9. From ordinary cognition to recognizing revelation

<a id="section-xiii"></a>

If we cannot confidently infer what kinds of minds God would intend creatures to possess, we should also be cautious about assuming what those minds would be equipped to recognize. This problem takes a distinct form when the object of cognition is not an ordinary environmental feature or a medical condition but a purported communication from God.

The predator example provides a limited analogy: both detecting a threat and assessing a purported revelation involve judgment under uncertainty. But the adaptive value of a low threshold for defensive action does not determine how a person should evaluate a claim to divine authority.

Consider a person who encounters a purported revelation. The experience may take the form of a reported miracle, a sacred text, a prophetic claim, a religious experience, or testimony from someone who believes God has spoken. The person must determine whether the claim is genuine, what it means, and whether accepting it is warranted. These tasks involve uncertainty, but evolutionary pressures that favored recognizing predators do not establish that the same cognitive mechanisms are suited to evaluating divine communication. The assessment itself involves three distinct questions:

| Stage | What must happen | A difficulty that may remain |
| --- | --- | --- |
| Reception | The purported message reaches a person. | It may never arrive, or may arrive through incomplete transmission. |
| Authentication | The person has grounds to identify its source. | Sincere testimony or an intense experience need not settle whether the source is divine. |
| Interpretation | The person understands its content. | A message may be received and even authenticated while its meaning remains disputed. |

Reception concerns whether a purported message reaches a person at all; authentication concerns whether its source can be identified as divine rather than human, mistaken, or otherwise nondivine; and interpretation concerns what it communicates. The stages can come apart: someone might receive an accurate report of a purported revelation but have difficulty assessing its source, or correctly identify a message as authoritative while misunderstanding its content.
...
<a id="chapter-10"></a>
### 10. Competing revelations and religious disagreement
...
<a id="chapter-11"></a>
### 11. Geography and unequal access to religious evidence
...
These observations do not imply that a religion is false because its adherents are geographically concentrated, nor that a person’s beliefs are unjustified because they were learned from parents or a religious community. Religious affiliation, exposure to a claim, and a fair opportunity to evaluate its supporting evidence are distinct: survey data about the first cannot establish the other two on their own. Nearly everyone acquires much of their knowledge through testimony, education, and social relationships. Dependence on one’s environment is an ordinary feature of human knowledge, not a defect peculiar to religion.
...
<a id="chapter-12"></a>
### 12. The *sensus divinitatis* and divine assistance
...
<a id="chapter-13"></a>
### 13. Freedom, faith, and divine hiddenness
...
<a id="part-iv"></a>
## Part IV — Divine psychology and the limits of explanation

The final question concerns the standard applied throughout: what can appeals to divine intentions explain when those intentions are partly uncertain?

<a id="chapter-14"></a>
### 14. The knowability dilemma: divine psychology and the limits of explanation
...
Nor can we estimate that likelihood merely by selecting a favorable description of divine intentions. If the broader theistic hypothesis leaves God's intentions uncertain, the assessment must account for the different purposes that are genuinely supported and for what each would lead us to expect. This is a schematic point about reasoning under uncertainty, not a claim that God's intentions are random or that all conceivable intentions deserve equal weight. Explaining the observation under one possible intention does not establish its likelihood under the broader hypothesis; failing to identify a divine reason does not establish a low likelihood either. As Anderson's treatment of hiddenness illustrates, an observation may count against theism while the total evidence still leaves theistic belief reasonable ([Anderson, 2025](#ref-anderson)).
...
This is the knowability dilemma. To use divine intentions to explain why our minds are reliable, why their limitations are justified, or why revelation takes its particular form, we need some warranted understanding of those intentions. But when unfavorable observations arise, an unrestricted appeal to their inscrutability threatens the very expectations that gave the earlier explanations evidential force. The dilemma does not prohibit mystery; it requires that appeals to what is known and unknown about God be applied consistently.
...
- Critical Thinking Academy. “[When an Explanation Explains Too Much](https://afontana1.github.io/critical-thinking-academy/religion/divine-psychology/blog.html).” The author’s earlier discussion of divine psychology, discussed in Part I, Chapter 2.
