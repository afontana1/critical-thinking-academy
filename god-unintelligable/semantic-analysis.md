# "God Exists" is an Unintelligable Statement
...
Let's begin by considering various aspects of word/sentence meaning. A practical way to analyze a word semantically (what it contributes to meaning) and pragmatically (how context and use shape what it does), is to use concepts from linguistics like [deixis](https://en.wikipedia.org/wiki/Deixis), orientation, [indexicality](https://en.wikipedia.org/wiki/Indexicality), tense/aspect/mood, etc. This is going to seem very pedantic at first, but it will all come together eventually. When analyzing a sentence, we first need to consider what type of word we are dealing with. Different categories of words invite different questions:
...
2. Branch B2: “It’s self-evident; everyone knows it”: Treat this as a presumption / common-knowledge move and tighten the dialogue standards.
  ...
  I am not trying to win by denial; you’re trying to keep the dialogue honest about what kind of move is being made—assertion vs framework-setting, evidence-bearing claim vs presumption, and whether the speaker is meeting the responsibilities that go with the posture they’ve adopted.
...
2. Category shifts: literal vs analogical predicates
...
3. Immunizing maneuvers and goalpost drift - A third pattern is a kind of **evidential posture inconsistency**:
...
In programming languages, formal logic, data modeling, and systems engineering, a statement isn’t considered meaningful just because it is grammatical. It has to be well-formed under some specification:
 ...
 - Dynamic semantics (evaluation): what does it do / how is it interpreted?
 -Model/denotation: what structure in the world (or model) makes it true/false?
...
- ["Cognitive Science of Religion"](https://ora.ox.ac.uk/objects/uuid%3A9fdfa5e2-249c-46fd-87da-0d13b60c3c37/files/m7e131b8b0742d6390becc105d9845469)
- ["Why Are Rocks Pointy? Children's Preference for ..."](https://www.bu.edu/cdl/files/2013/08/1999_Kelemen_PointyRocks.pdf)
- ["Religion is natural - Mind and Development Lab"](https://minddevlab.yale.edu/sites/default/files/files/Religion%20is%20natural.pdf)
- ["Children's preferential recall of minimally counterintuitive ..."](https://pmc.ncbi.nlm.nih.gov/articles/PMC3769480/)
- ["The misunderstood limits of folk science - PubMed Central - NIH"](https://pmc.ncbi.nlm.nih.gov/articles/PMC3062901/)
...
- ["Compensatory Control"](https://rcgd.isr.umich.edu/wp-content/uploads/2018/08/Kayetal_2009.pdf)
- ["The evolution of costly displays, cooperation and religion"](https://www2.psych.ubc.ca/~henrich/pdfs/evolution%20of%20costly%20displays%20_henrich%202009.pdf)
- ["Scorekeeping in a language game"](https://semantics.uchicago.edu/kennedy/classes/f09/semprag1/lewis79.pdf)
- ["Relevance Theory"](https://people.bu.edu/bfraser/Relevance%20Theory%20Oriented/Sperber%20%26%20Wilson%20-%20RT%20Revisited.pdf)
- ["Robert Stalnaker: Common Ground"](https://semantics.uchicago.edu/kennedy/classes/f07/pragmatics/stalnaker02.pdf)
...
- ["Bertrand Russell | On Denoting"](https://users.drew.edu/~jlenz/br-on-denoting.html)
- ["Descriptions - Stanford Encyclopedia of Philosophy"](https://plato.stanford.edu/entries/descriptions/)
- ["Bertrand Russell | Biography, Essays, Philosophy, & Facts"](https://www.britannica.com/biography/Bertrand-Russell)
