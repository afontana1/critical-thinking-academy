...
The reporting around Turning Point USA’s alternative show paints it as a deliberate counter-message to the NFL’s official halftime headliner, including explicitly “patriotic” branding and stacking it with right-coded celebrities like Kid Rock.
That’s not “apolitical entertainment.” It’s an identity performance: *this is the “real America” show*. Even if some people insist it’s “not race, it’s politics,” the pattern can still be **racialized** (and often **xenophobic**) in practice:

* **Spanish as a trigger**: When “he’s going to sing in Spanish” gets treated as evidence of not being “American enough,” that’s not a policy argument — it’s a cultural boundary.
...
You can see this dynamic in mainstream coverage that explicitly frames Bad Bunny’s halftime appearance as a political flashpoint tied to immigration enforcement rhetoric and broader MAGA media backlash.
...
And the “alternative halftime show” idea makes it almost comically explicit: it’s not just *having politics*, it’s **counter-programming a mass ritual** to assert who counts as “America.” That is why it feels so blatant. The objection isn’t to identity politics; it’s to *other people’s* identity politics. When conservative identity is foregrounded, it’s framed as patriotism and values. When Latino identity or dissent is foregrounded, it’s framed as DEI or disloyalty.
...
When I explained the electric-pole image as Bad Bunny representing Puerto Rico’s power outages, someone replied: “Well, that’s just hypocritical. Here they are in America using energy. If they cared so much, why don’t they do something about it?” This is a patterned response—so patterned that we can identify the general form of the implicit argument. It appears everywhere as a way to reject criticism without evaluating it: “If you care about X, do something about X.”

I responded that many people did, in fact, try to help by sending money. That challenges one assumption, but another remains: that donations can solve the problem. This massively understates what a grid failure is. Repairing a power system requires governing bodies, utilities, engineers, contractors, long-term capital, and coordination; it is not something private donations can resolve. That is precisely what makes the response useful as a deflection: it relocates responsibility and obscures the root cause.

A similar argument appears when people call for higher taxes on the wealthy to fund social programs. Someone will point out that billionaires have too much money, and the response is “well look at you, you have a car” or something very minor. This obviously misses the point of the policy position: massive wealth distorts policy through rent seeking, wealth extraction leads to instability, wealth concentrated means less wealth flowing to communities in need, etc. I think both arguments are very similar, and they’re both not thoughtful. I believe this thoughtlessness is a symptom of how diluted public discourse has become, for reasons I’ll elaborate on in the next section. But for now, let's address these forms of argument.

#### Three Recurring Critique-Nullifiers

| Pattern | Implicit logic | What it obscures | Example |
|---|---|---|---|
| **Tu quoque / hypocrisy** | You participate in the system, so you cannot criticize it. | Participation may be unavoidable, and inconsistency does not determine whether the criticism is true. | Bad Bunny uses electricity while criticizing Puerto Rico’s grid failures. |
| **Personal-remediation test** | If you really cared, you would personally solve the problem. | Structural problems require institutional authority and collective capacity. | Asking an artist to repair an electrical grid. |
| **Scale collapse** | You own something, so you cannot criticize extreme concentrations of wealth. | Ordinary consumption and billionaire-scale economic or political power are not equivalent. | “You own a car, so you cannot support taxing billionaires.” |

> **Critique-nullifier:** Unless you personally escape or repair the system you criticize, your criticism is treated as invalid.
...
2. It treats a structural/institutional failure like a consumer choice - Power restoration and grid hardening require:
...
The overview above shows the family resemblance. The full **Walton-style argumentation schemes** below preserve the premises, hidden assumptions, and **critical questions (CQs)** needed to test each pattern rigorously.

<details>
<summary><strong>Full scheme: Argument from hypocrisy / inconsistent commitment</strong></summary>

**Scheme 1: Argument from Hypocrisy / Inconsistent Commitment (Tu quoque)**
...
* (A): “Bad Bunny performed in the U.S. using electricity ⇒ hypocrisy ⇒ critique invalid.”
  CQs 1, 3, 4, 6 are especially lethal: hypocrisy (even if true) doesn’t refute the claim; electricity use is non-optional; rebuilding grids is institutional; independent evidence exists.

</details>

<details>
<summary><strong>Full scheme: “If you care, you must personally fix it”</strong></summary>

**Scheme 2: “If you care, you must personally fix it” (A distorted **Argument from Practical Commitment** / **Argument from Responsibility**, often functioning as a derail)**
...
* Required (A) is implicitly “fix the grid / rebuild infrastructure.”
  CQs 2 and 3 are decisive: grid repair isn’t an individual-level remedy; authority lies with government + utilities + contractors; “doing something” includes advocacy and accountability.

</details>

<details>
<summary><strong>Full scheme: “You have a car, so you cannot criticize billionaires”</strong></summary>

**Scheme 3: “You have a car, so criticizing billionaires/taxes is hypocritical” (Blend of Scheme 1 + **False Equivalence / Scale Collapse**)**
...
The “think of the children” claim is being used alongside language/culture objections. The most on-the-nose example is Donald Trump’s post after Super Bowl LX, which (per reporting) explicitly complained about the performance being in Spanish and also framed parts of it as inappropriate for children. That combination matters: it’s not “purely about sexual content” — it’s also about cultural “Americanness” signaling. The alternative show was *marketed* as values-forward, which invites the hypocrisy critique. TPUSA described its “All-American Halftime Show” as centered on “faith” and “family values,” positioned as an alternative to what It framed as political messaging. So when that lineup includes Kid Rock, the “family-friendly” justification starts to look less like a principle and more like a **pretext** (or at least a selectively applied standard).

* **If vulgarity were the real concern**, then vulgar artists would be criticized consistently regardless of ideology.
* **But the outrage is asymmetric**: “vulgar” is deployed against Bad Bunny while the counter-program embraces partisan aesthetics and performers whose brands aren’t exactly PG, and it still gets labeled “values” and “patriotism.”

That asymmetry strongly suggests the “kids” argument is **strategic**: a socially acceptable wrapper for other objections (political dissent, cultural change, Spanish-language visibility, etc.).
...
Under these dynamics, arguments get worse for a vareity of reasons. First, the ecosystem rewards dismissal moves. A lot of the highest-performing “arguments” aren’t about truth; they’re about **ending the conversation**: “If you care, why don’t you fix it?”, “You live in society, curious!”, or “They’re indoctrinating kids.” These are rhetorically efficient because they require no evidence and force the other person onto defense. Second, grievance politics and persecution frames are “unfalsifiable glue”. Once a group identity is built around *being under attack*, every symbol can be interpreted as hostile. That produces paranoia (“hidden agenda everywhere”), anti-intellectualism (context = “excuses”), and escalating certainty (nuance = disloyalty). Low-quality arguments are not random; they’re the predictable output of an attention-optimized ecosystem in which participatory disinformation and influence operations (coordinated or structural) select for identity-confirming frames over accurate interpretations.
...
## Alex Pretti and the Construction of Evidence

“Evidence” sounds like a simple, objective relationship—*E supports H*—but actual inference is mediated by background assumptions, concepts, standards, goals, and social context. Two people can therefore share many of the same facts and still disagree, reasonably or unreasonably, about what those facts support. The Alex Pretti case shows how media systems can artificially amplify this underdetermination by changing the categories, trust relationships, and standards through which facts become evidence.

Evidence is not a property of a fact alone; it is the role a fact plays inside an argument.

| Element | Function |
|---|---|
| **Data / fact** | An observation, testimony, measurement, or record. |
| **Hypothesis / theory** | The explanatory account or possibility being evaluated. |
| **Linking assumptions** | The conditions under which the data would be expected if the hypothesis were true: measurement reliability, causal story, category definitions, base rates, and so on. |
| **Standards of relevance** | The kind and degree of support that count: prediction, explanation, coherence, robustness, or practical stakes. |
...
Several mechanisms can make the same fact support opposite conclusions. They may look alike on the surface—“we disagree about the evidence”—but they locate the disagreement in different places.

| Mechanism | What changes | Why the same fact can point elsewhere |
|---|---|---|
| **Background beliefs** | Priors, base rates, auxiliary assumptions, or likelihoods such as *P(E\|A)* and *P(E\|B)*. | If people assign different likelihoods, they can disagree about the evidential direction. |
| **Reference class** | What kind of case the event is taken to be. | “He left early” can indicate disinterest on a date or responsibility when a parent leaves to collect a child. The behavior is the same; the classification changes the inference. |
| **Causal story** | The pathway believed to have produced the observation. | An alternative cause can make *E* expected even when *H* is false, thereby “explaining away” the original inference. |
| **Standard of support** | The threshold or form of evidence considered sufficient. | People may agree that *E* raises *P(H)* but disagree about whether the effect is robust, replicable, resistant to cherry-picking, or strong enough to act on. |
| **Feature selection** | Which dimension of a complex observation receives attention. | One person treats an outlier, time window, witness incentive, or variance as signal; another treats it as noise. |

It is also common for a person to move from “E supports A” to “E supports B.” Sustained media exposure can produce that shift through routes that are coherent in principle, socially driven, or some mixture of both.

| Route | Mechanism | Effect on the evidential relationship |
|---|---|---|
| **Model revision** | New auxiliary beliefs: the measurement is biased, or the causal mechanism differs from what was assumed. | What *E* discriminates between changes because the world-model changes. |
| **Question revision** | The question shifts from “Is A true?” to “Is A the best explanation?” or “Is A what matters?” | The same observation is evaluated against a different target. |
| **Hypothesis-space revision** | A new alternative, B, becomes a live possibility and fits *E* better. | Probability mass can move without violating Bayesian coherence. |
| **Motivated reasoning** | Identity, group status, or moral signaling makes B preferable. | The person reweights what Is allowed to count. |
| **Availability and salience** | Media makes certain examples vivid and apparently typical. | The perceived base rate or normal case shifts. |
| **Concept drift** | Terms such as “fraud,” “violence,” “freedom,” or “expert” change meaning. | The same *E* is now treated as evidence about a different concept. |
| **Trust realignment** | Different sources become credible or incredible. | The set of claims treated as facts changes before inference begins. |
...
Those are not small technicalities; they are where much of the disagreement lives. In practice, we rely on *meta-evidential* norms—criteria for judging whether a putative *E* is trustworthy as evidence.

| Meta-evidential norm | Diagnostic question |
|---|---|
| **Independence** | Does the result survive when measured in different ways? |
| **Robustness / replication** | Does it recur across methods or contexts? |
| **Specificity** | Is it predicted distinctively by *H*, or equally well by many rivals? |
| **Resistance to cherry-picking** | Does it depend on selective time windows, metrics, or anecdotes? |
| **Error sensitivity** | Would we be likely to notice if the conclusion were wrong? |
| **Adversarial testing** | Has it survived scrutiny from people who actively want to debunk it? |
...
When you hear “E is evidence for H,” silently expand it:

> **Under description D of the data, within model M, given background assumptions B, with standards S, and for question Q, evidence E supports hypothesis H.**

| Point of disagreement | What to ask |
|---|---|
| **D — Description** | What is the fact, and which aspect of it matters? |
| **M/B — Model and background** | Which causal story, base rates, reliability assumptions, and incentives are in play? |
| **S — Standards** | What level or type of support counts? |
| **Q — Question** | What are we actually trying to decide? |

This is the meta-evidential level at which media systems operate.

### From Evidence to Classification

What revived this line of questioning was the recent killing of Alex Pretti. I know people who, in the past, viewed similar events as clear brutality and murder. However, after massive exposure to Fox News, and other life events, they see the Alex Pretti case as a clear example of “terrorism” or whatever the current federal government’s narrative is.

People can “see the same event” yet slot it into *brutality/murder* versus *terrorism*. This is almost a textbook case of how **classification frames** and **trust networks** turn raw facts into “evidence for X.” Using the Alex Pretti case as the anchor: the dispute isn’t only “what happened,” it’s also “*what kind of thing was it?*” In public reporting, you can already see (1) contested factual claims about the encounter and (2) official/political labels being applied (e.g., “domestic terrorist,” “would-be assassin”), alongside calls for investigations. Here are the main moving parts that produce the divergence:

A lot of disagreement happens *upstream* of “probability raising,” at the level of **what gets treated as the stable fact**. In this case, different information environments emphasize different “base facts”: official statements about the threat posed / firearm / resistance,  video interpretations (what was in his hands, what happened right before shots, etc.) , and internal/preliminary review claims that contradict an initial narrative. If someone comes to treat *the government’s characterization* as the primary datum (and contrary footage as deceptive/edited/out-of-context), then the evidential pipeline flips even if the “surface facts” sound similar.

Labels like “terrorism” aren’t just descriptions; they bundle an entire causal-moral package: who is presumed the aggressor, what level of force is presumed justified, and whether the event is treated as a one-off tragedy or part of a larger coordinated threat. So the same observed elements (“there was a gun nearby,” “there was a protest,” “agents shot him”) can be *reinterpreted* once the category is chosen. And crucially: in public discourse, category selection is often driven by **authority cues** and **coalitional cues** (who said it, which side says it), not just by a neutral review of details. You can see high-profile figures amplifying “assassin/terrorist” framings even amid disputed accounts.

When two people argue, the disagreement may look like “same facts, different inference,” while actually operating at one of two levels:

| Type of dispute | What is contested | What could move the disagreement? |
|---|---|---|
| **Factual-model dispute** | What happened; whether he was armed at the moment he was shot; whether video, DHS statements, witnesses, or internal reviews are reliable; and which causal sequence best explains the encounter. | Better evidence—body-camera releases, independent investigations, and corroborated timelines—can move beliefs, provided the evidence-generating institution is trusted. |
| **Norm / identity dispute** | What “counts” as terrorism, what level of threat justifies lethal force, and which institutions possess epistemic authority. | Additional facts may do little because the disagreement concerns standards, category boundaries, trust, and allegiance rather than data alone. |

Long media exposure can genuinely change what counts as evidence. Even without conscious bad faith, people can undergo a kind of **lens training**.

| Form of lens training | Result |
|---|---|
| **Salience training** | Repeated examples make one interpretation feel obvious or typical. |
| **Suspicion inversion** | Contrary sources are treated as inherently manipulative, so disconfirming facts become evidence of a cover-up. |
| **Concept drift** | “Terrorist” expands from politically motivated violence against civilians to anyone opposing state enforcement while appearing potentially threatening. |
| **Default causal script** | “Protester + gun” automatically activates an “attack on law enforcement” narrative. |

Once those updates occur, the same *E* is routed differently—not necessarily because someone consciously ignores evidence, but because the *epistemic wiring* that determines what evidence is has changed.

> **Four diagnostic questions**
>
> 1. What are you treating as the fixed facts: video, official statements, medical-examiner classification, or witness reports?
> 2. Which sources are allowed to count, and which are disqualified in advance?
> 3. Which category is being applied—terrorism, murder, tragedy, justified force—and what does that category imply?
> 4. What would change your mind? A concrete potential finding suggests at least partial evidence-responsiveness; “nothing” suggests the judgment is primarily coalitional.

In later sections, we will discuss how media can effectively change these epistemic norms and frames.

#### The Stable Facts and the Competing Frames

Multiple major outlets describe video/forensic analyses show two incontrovertible facts: **(1) he’s disarmed**, and then **(2) agents fire ~10 rounds into him**. Reuters reported verified video footage, showing him holding a cellphone, being wrestled/disarmed, and then shot, and ABC reports a forensic audio analysis finding **10 shots in under ~5 seconds**. People also summarizes footage (citing other reporting) as showing him unarmed/holding a phone while pinned. So given *those* facts, the interesting question becomes: **how can someone still come away with “terrorism” (or “justified”) rather than “brutality/murder”?** Here are the main mechanisms that produce that divergence—even when people aren’t consciously lying.

| Interpretive frame | Controlling question | Evidential center | Typical conclusion |
|---|---|---|---|
| **Terminal-slice / use-of-force frame** | Was lethal force justified at the moment the shots were fired? | Disarmed → shot repeatedly. | Brutality, wrongful killing, or murder. |
| **Process-slice / security-state frame** | Was this person part of a threatening event or category? | Threat emergence → struggle → risk to agents → lethal force. | Neutralization, split-second response, or tragic necessity. |

A “terrorism” lens can treat *the disarmed moment* as almost irrelevant, because it’s classifying the person/event as belonging to a threat category: “He was a terrorist *because he intended violence / was part of an attack / aligned with a cause*”. Then the shooting is interpreted as “neutralization,” “split-second,” “chaotic,” or “tragic but necessary.” So the evidential center moves from **what happened at second T** to a broader claim like **what kind of actor this was**. That is why two people can agree “he was disarmed” and still disagree on the headline label.
...
In polarized contexts, endorsements by officials (e.g., Department of Homeland Security statements) or party-aligned figures can function as evidence *even when the underlying factual claims are contested*. And when later evidence contradicts initial narratives, some people update; others double down by treating the contradiction itself as proof of a conspiracy or hostile media. Reuters also reports DOJ/DHS civil-rights review activity around the incident, which becomes “evidence” differently depending on trust.

Even if everyone agreed on the two facts, people can still diverge because they’re answering different implicit questions: “Was lethal force justified at the moment he was disarmed?” versus “Was he a member/example of a threatening category, and are agents broadly justified against that category?" Those are *not the same inferential target*, so “what counts as evidence” shifts. A good question to ask your interlocutor in discussions like these is: “What specific new information would make you stop calling it terrorism and start calling it unjustified killing?” If they can name concrete potential updates (body-cam release, timeline, independent reconstruction), they’re at least *somewhat* evidence-responsive. If the answer is “nothing,” it is almost purely coalitional. The latter is unfortunately what characterizes most situations. Many people think it is noble to firmly entrench yourself in an opinion regardless of counterevidence. They actually treat it as a virtue.

### A Bayesian Model of the Pretti Dispute

Bayesian updating is a rule for *conditionalizing once a model already exists*, but much of the real action lies in **model formation**: deciding (i) what the hypothesis space is, (ii) what counts as an observation, and (iii) how that observation is generated. Bayes tells you how to update **inside** a model; it does not, by itself, determine which model you should inhabit. Anyone who studies statistics may object that model-selection criteria exist, and of course they do. My point is that the space of models a person seriously considers is itself shaped by meta-level filters, including media. Deciding what counts as evidence is therefore largely a matter of **choosing and constructing the model**.
...
Two people can update in opposite directions without violating Bayes because they may be working with different model inputs.

| Degree of freedom | Example | Consequence |
|---|---|---|
| **Hypothesis space** | One person considers {A, not-A}; another considers {A, B, C}. | A newly live alternative can explain away what previously supported A. |
| **Description of E** | “He was shot ten times,” “he was shot ten times after being disarmed,” or “a video appears to show X.” | These are different propositions: raw stream, testimony, measurement, and interpreted claim are not interchangeable observations. |
| **Likelihood model** | Two people assign different values to *P(E\|H)* because they disagree about source reliability, selection effects, incentives, or background conditions. | The same stated facts can produce opposite posterior movements. |
...
The Bayesian point becomes concrete in the Alex Pretti case because we can name the hidden variables people are implicitly contesting. Major reporting supports something close to the summary below, with the ordinary caveat that investigations are ongoing.

| Reported item | Relevance to the model |
|---|---|
| Reuters-verified video shows Pretti holding a cellphone, being wrestled to the ground and disarmed, then being shot moments later. | Defines a detailed candidate observation rather than a broad category label. |
| ABC reports a forensic audio analysis finding **ten shots in under five seconds**. | Adds a temporal and quantitative feature to the evidence. |
| AP reports videos that contradict initial DHS claims and show a firearm being removed while he appears to hold only a phone. | Creates a conflict between official narration and visual evidence. |
| Reuters reports that an initial government review did **not** mention him “brandishing” a firearm, contrary to early rhetoric. | Changes the reliability assessment of the initial narrative. |
| Reuters fact-checks viral edited imagery implying that he held a gun in his hand. | Shows how manipulated evidence objects can alter the trust variable. |

**Competing hypotheses**

| Hypothesis | Claim being evaluated |
|---|---|
| **H₁ — Unjustified lethal force / wrongful killing** | Lethal force was not justified at the moment the shots were fired. |
| **H₂ — Justified lethal force** | Lethal force was justified because of an imminent threat or a reasonable perception of threat. |
| **H₃ — “Terrorism” framing** | Pretti was a terrorist or would-be attacker—a category or intent claim—and the shooting is treated as neutralization. |

**Candidate evidence variables**

| Evidence variable | Observation |
|---|---|
| **Eᵥ** | Verified bystander video shows him holding a phone, pinned or disarmed, and then shot. |
| **E₁₀** | Ten shots were fired in fewer than five seconds, according to forensic audio analysis. |
| **Eₒ** | The initial official or DHS narrative emphasized a firearm and threat, even where later evidence disputed details. |

Bayes’ rule updates the odds inside a model:
...
People are not simply updating on “what happened.” They are often updating through latent variables that decide which observations are admissible and which question the evidence is answering.

| Latent variable | High / first setting | Low / alternative setting | Effect |
|---|---|---|---|
| **T — Trust** | Reuters/AP/ABC verification is treated as reliable, so **Eᵥ** is high-quality evidence. | Mainstream outlets are assumed to manipulate or omit context, so **Eᵥ** is demoted to propaganda or even treated as evidence of conspiracy. | Two people can hear “the video shows he was holding a phone” and route the statement in opposite directions. Viral altered imagery further destabilizes T. |
| **F — Frame** | **Use-of-force frame:** Was lethal force justified at the moment of shooting? | **Threat-category frame:** Was he the kind of person or event that counts as terrorism? | The same observation answers a different inferential question. |

Under the threat-category frame, the *moment* of being disarmed can be demoted in relevance. The model shifts from “imminent threat now” to “intent / affiliation / category,” which is not the same hypothesis. Bayes cannot tell you which F to adopt; it can only update once you’ve adopted it. The divergence is therefore not mainly about Bayes’ rule. It is about the inputs.

| Input | Disputed question |
|---|---|
| **Hypothesis space** | Is “terrorist” a live hypothesis? Is “state murder” a live hypothesis? |
| **Evidence variable** | Is the bystander video a legitimate observation, or is the official narrative the controlling observation? |
| **Likelihood model** | How often would “disarmed + ten shots” occur under justified force compared with unjustified force? |
| **Trust and framing variables** | Which channels certify evidence, and which inferential question is being asked? |

That is why the same public event can produce opposite posterior movements even among “Bayes-respecting” reasoners. A sharp way to test whether someone is updating on evidence or allegiance is to ask them to specify **an observation that would have high likelihood under the rival hypothesis**. For example, if someone is in the “terrorism / justified” camp, ask: “If independent body-cam angles show he was pinned and his firearm was already in an agent’s hand *before* the first shot, what does that do to your confidence in ‘justified’?” (AP/Reuters reporting suggests the video is already close to this.) If they can articulate a counterfactual that would move them, they’re at least modeling evidence. If they can’t, then their “Bayes” is effectively frozen because priors/trust/frame dominate.

### From Disagreement to Epistemic Capture

What the Alex Pretti case shows at a deeper level is not merely disagreement over an incident; it’s the way **media ecosystems can rewire the inputs to reasoning**—your categories, priors, likelihoods, and even what counts as a datum worth updating on. You can see the basic ingredients in the public record:

* There’s contested narration early on from officials, and then a lot of public attention to bystander video and reconstructions. Reuters reports verified video showing Pretti holding a cellphone, being wrestled/disarmed, then shot; Reuters also reports a preliminary CBP review that didn’t include the “brandishing” claim that circulated in the first hours.
* There was also an explicit “information war” artifact: Reuters fact-checked a viral edited still that nudged viewers toward “he had something (a gun) in his hand,” illustrating how small manipulations can steer interpretation.
* Independent / transparent investigation demands became part of the story itself, with former DOJ lawyers calling for transparency and polling showing broad support for independent investigation.
...
Profit + algorithms push toward frames that are *high engagement*, not high accuracy. Two mechanisms matter a lot. First, Engagement incentives favor high-arousal frames. Platforms and audience-driven media reward content that triggers outrage, fear, and certainty—because it keeps people watching/sharing. That doesn’t merely misinform; it **selects for frames that are resistant to disconfirmation** (e.g., conspiracy-friendly frames where counterevidence proves the conspiracy). Research/policy summaries on polarization and platform incentives describe how algorithmic distribution and self-selection can create homogeneous clusters and accelerate misinformation diffusion. Second, Participatory disinformation turns users into co-producers. “Participatory disinformation” is exactly what It sounds like: people aren’t just consuming a narrative; they’re *helping make it*. The Reuters edited-still episode is an example of how small “crowd-sourced interpretation hacks” can be amplified until they feel like common knowledge. That co-production creates identity investment: backing down isn’t just updating a belief; it’s abandoning a team contribution.

Institutional rot isn’t only “bad actors”; it’s broken feedback loops.  **Information correction** gets weaker when local institutions can’t credibly investigate or communicate, or when federal/local conflict makes transparency harder (raised in reporting about investigative friction and calls for independent probes). **Accountability capacity** can be affected by staffing/mandate changes and selective enforcement patterns—Reuters has reporting more broadly about scaled-back civil-rights enforcement capacity and how that interacts with cases like Pretti’s. In Bayesian language: the system’s ability to generate high-quality (E) deteriorates, and then people rationally (or semi-rationally) fall back on identity/trust proxies. These are feedback loops inherent to the system.
...
### From Frames to Causal Scripts

Causal scripts diffuse through social networks through platform incentives, influencers, and algorithmic boosting. As they spread, public discourse degrades into patterned responses whose form is often predictable in advance. What people say becomes a variation on a small repertoire licensed by platform and media norms; many apparent “arguments” function less as attempts at reasoning than as thought-terminating clichés and signals of identity. This is the ecosystem-level story: **causal scripts**—ready-made explanations joined to moral conclusions—are structurally favored by attention systems. The result is **degraded discourse** in which people talk past one another, disagreement becomes “deep” because it concerns trust and identity, and policy becomes stuck.

| Stage | What happens | Typical output |
|---|---|---|
| **Seeding** | Initial clips, labels, and causal frames appear. | “This is what the event really means.” |
| **Amplification** | Influencers select and package the frame best suited to audience and platform incentives. | A reusable hero–villain–victim narrative. |
| **Participation** | Users remix clips, captions, memes, “receipts,” and rebuttal fragments. | A crowd-produced narrative that feels organic. |
| **Normalization** | Repetition and social rewards create perceived consensus. | “Everyone knows” the accepted interpretation. |
| **Self-sealing** | Outside sources and counterevidence are discredited in advance. | The script becomes resistant to revision. |

Causal scripts usually do not become dominant all at once. They tend to spread in stages, moving from a niche interpretation to a default lens for understanding events, and the first push often comes from the way platforms are designed. On major social platforms, ranking systems heavily reward engagement signals like replies, reshares, and watch time, and research consistently shows that this tends to amplify emotionally charged and divisive content because outrage and conflict generate exactly those kinds of reactions. In practice, that gives certain narratives a built-in advantage: scripts that make people angry, afraid, or morally certain travel farther and faster than ones that ask for patience or nuance.
...
Once one of these templates starts gaining traction inside a particular community, algorithmic boosting and network structure can turn it into a cascade. Social networks are shaped by homophily, so people are often surrounded by others who already share similar views, and that makes reinforcement easy. Likes and retweets function as social rewards, repeated posts across multiple accounts create the appearance of consensus, and remixable formats like clips, stitches, and quote-tweets help the script spread while preserving its core message. Formal social network models show how misinformation and fake news interact with these network dynamics to increase polarization and lock in false beliefs over time.

What makes this especially durable is that the process is not only top-down. Audiences do not simply consume the script; they become active participants in producing, refining, and maintaining it. Communities collaboratively “work” the narrative by extracting and cutting clips, writing captions, creating memes, collecting “receipts,” inventing rebuttal fragments and shared phrases, and building a common vocabulary around the story. Research on participatory disinformation describes how these collaborative dynamics can shape narratives and sustain them long after the original post or claim has disappeared. By that point, the script is no longer merely a message people encountered. It is a communal object they have helped build, circulate, and defend, creating both social and emotional investment in keeping it alive.
...
If you want to put it in Bayesian terms, these phrases often act like likelihood-nullifiers: they make it so that no possible evidence (E) will count against a favored hypothesis (H), because the channel that produced (E) has already been declared illegitimate. Once that move is in place, the conversation may still look like an argument on the surface, but functionally it has stopped being one. The full mechanism can be compressed into a single chain:

| Mechanism | Consequence |
|---|---|
| Engagement-based ranking rewards high-arousal, conflictual content. | Emotionally charged frames receive a distribution advantage. |
| Influencers and communities package repeatable causal scripts that fit those incentives. | Complex events become portable templates with heroes, villains, and action cues. |
| Algorithmic diffusion and homophilous networks turn scripts into default lenses. | The frame begins to feel like common sense rather than one interpretation. |
| Scripts compress discourse into memetic argument forms, slogans, and thought-terminating clichés. | Responses become predictable, rapid, and identity-signaling. |
| The epistemic commons erodes as groups diverge over trust, categories, and standards. | Compromise is recoded as identity betrayal, producing deep disagreement and policy impasse. |
...
* **C. Thi Nguyen** on *epistemic bubbles vs echo chambers* (and why echo chambers are hard to “pop”)
* **Endre Begby** on *evidential preemption* (how testimony can inoculate audiences against later counterevidence)

| Structure | Main mechanism | Why ordinary correction fails |
|---|---|---|
| **Epistemic bubble** | Relevant outside voices are missing by omission. | Exposure to the missing perspective may still correct the belief. |
| **Echo chamber** | Outside voices are actively discredited and members are trained to distrust them. | New exposure is reinterpreted as proof that outsiders are corrupt or deceptive. |
| **Evidential preemption** | Audiences are warned in advance that future contrary evidence will be misleading. | Counterevidence arrives already classified as propaganda, manipulation, or a rigged process. |
...
#### Bubbles Omit; Echo Chambers Discredit

Nguyen’s key distinction is really useful here because it separates two things that often get lumped together. In an epistemic bubble, important voices are missing mostly by omission—you simply do not encounter them, so your view of the world is incomplete. In an echo chamber, though, the dynamic is much stronger: outside voices are not just absent, they are actively excluded and discredited, and members are trained in advance to distrust anything those outsiders say.
...
#### Evidential Preemption: Inoculation Against Counterevidence

Begby’s mechanism helps explain exactly how these narratives become self-sealing, because the persuasion is not just about getting someone to believe a claim in the moment. It is about shaping how they will interpret future evidence. His idea of *evidential preemption* is, roughly, that a speaker asserts a claim (p) while also warning the audience that they will later encounter apparent evidence against (p)—but that this future evidence should be treated as misleading, deceptive, or already accounted for. In other words, the message arrives with its own built-in defense system.

You can see the structure everywhere in politics and media: “They’re going to tell you X, but that’s propaganda,” or “that clip is out of context,” or “it’s a hoax,” or “those are paid actors.” The power of this move is that it does not just persuade you now; it pre-programs your response later. When counterevidence eventually appears, it no longer lands as counterevidence. It lands as confirmation that the warning was correct. Begby explicitly describes this as a kind of inoculation—an audience is primed in advance to resist future contrary evidence.

When you combine that with Nguyen’s distinction, the full loop becomes clear. In an echo chamber, outsiders are already discredited, so their testimony is treated as suspect before it is even heard. Then evidential preemption adds a second layer: any future contradiction is pre-labeled as manipulation, which means it never gets to function as evidence in the first place. That is the core of the self-sealing dynamic you are describing: not just disagreement, but a structure that protects itself by training people how to dismiss disconfirming evidence before it arrives.

#### The Self-Sealing Pattern, Step by Step

| Stage | Epistemic function | Common moves |
|---|---|---|
| **Frame installation** | Defines what kind of event this is before facts are debated. | Law and order, terrorism, corruption, degeneracy, protection, betrayal. |
| **Authority mapping** | Ranks who is permitted to count as a reliable knower. | Trusted insiders versus corrupt outsiders. |
| **Preemption** | Lowers the evidential status of future contradiction. | “Fake news,” “out of context,” “paid,” “the investigation is rigged.” |
| **Ritualization** | Narrows acceptable responses into a familiar sequence. | Label → delegitimize → moralize → close inquiry → mobilize. |
| **Self-sealing** | Converts counterevidence into reinforcement and dissent into disloyalty. | The argument becomes a performance of membership. |
...
#### From Degraded Discourse to Policy Impasse
...
In Die Realität der Massenmedien, “selectors” (*Selektoren*) are **system-internal selection mechanisms/criteria** that reduce the overabundance of possible communications—i.e., they help determine **what becomes media communication and what does not**. Luhmann talks about “selectors” at **three related levels**:

| Level | Selectors | Function |
|---|---|---|
| **Communication theory** | Information, utterance (*Mitteilung*), and understanding (*Verstehen*). | Constitute a communication event through three linked selections. |
| **Mass-media structure** | Readiness to send (*Sendebereitschaft*) and audience interest in tuning in (*Einschaltinteresse*). | Couple organizations prepared to broadcast with audiences prepared to attend. |
| **News program** | Novelty, conflict, quantities, proximity, norm violation, moral evaluation, persons, topical events, and opinions. | Determine which events are selectable and how they are formatted as news. |

#### Selectors That Constitute Communication

For Niklas Luhmann, communication is not simply the transfer of a message from one person to another; it only happens when three selections come together as a single event of meaning. First, there is **information** (*Information*), which is the selection of *what* is being communicated—the specific difference being marked out from all the other things that could have been said. Second, there is **utterance** or **Mitteilung**, which is the selection of *that* information and the way it is presented—the act of saying, showing, framing, or expressing it in a particular form. Third, there is **understanding** or **Verstehen**, which is the selection made by the receiver (or observer) who interprets the utterance as communication and attributes a meaning to it, whether that interpretation is accurate or not. In this view, communication is not complete at the moment of speaking; it emerges only through the synthesis of these three selections, which is why Luhmann describes them as the classic “three selections” (*drei Selektionen*) of communication.

#### Structural Selectors of Mass Media

At the structural level, Luhmann argues that mass media operate with a different set of selectors because they exclude real-time interaction between sender and receiver. In face-to-face communication, participants can immediately respond, clarify, and adjust, but mass media systems do not work that way. Instead, he says two selectors become especially important: **Sendebereitschaft**, or the producer’s/organization’s readiness to send—to generate and offer content into the system—and **Einschaltinteresse**, or the audience’s willingness to tune in, pay attention, and accept the communication as worth engaging. In other words, mass media communication depends not only on what Is said, but on the structural coupling between institutions that are prepared to broadcast and audiences that are prepared to attend.

#### News Selectors at the Program Level

When he turns specifically to **news (as distinct from more background “reports”)**, he lists “typical” selectors for how news gets chosen and formatted. Here are **all the numbered selector types (1)–(9)** he discusses there:

| Selector | Selection effect |
|---|---|
| **Striking discontinuity / novelty** | Information must be new, break expectations, or resolve a bounded uncertainty such as a sports result. |
| **Conflict** | Conflict creates suspense by postponing resolution and pointing toward future winners, losers, and developments. |
| **Quantities** | Numbers attract attention in themselves; comparisons amplify their informational force. |
| **Local reference / proximity** | Local relevance gives an item weight; distance must be compensated by greater significance or oddity. |
| **Norm violations** | Legal or moral violations—and related breaches of “political correctness”—are readily formatted as scandal. |
| **Moral evaluation** | Norm violations become especially selectable when they permit judgments of esteem or contempt and reproduce a good/bad code. |
| **Persons / attribution** | Complex contexts are simplified by attaching events to actors, supporting rapid opinion formation. |
| **Topicality and single cases** | The demand for up-to-dateness concentrates news on incidents, accidents, disruptions, and serial follow-ups. |
| **Opinions as news** | Opinions become media events when the topic is interesting and the speaker possesses sufficient reputation or status. |

Luhmann then adds that this whole “net” of selectors is **reinforced by organizational routines** in media production.

In his news selectors, the “case” idea shows up in the selector that privileges **events / single incidents** (*Ereignisse*, *Einzelfälle*) because “topicality” demands items that can be marked as *new* and can be continued tomorrow as follow-ups. In other words: **news is biased toward discretely reportable cases** (accidents, disruptions, scandals, decisions, etc.). Right after (or alongside) listing selectors, Luhmann warns that a pure “list of criteria” is too simple, because **selection is an organizationally complex process**. He then says the selectors are **“reinforced and supplemented” by routines** in media organizations (newsrooms). Concretely, routines include things like:
...
* final selection by **available space/time** in the medium (column inches, airtime).

And his point is that it’s “surprising” how much what looks sensational is **produced by routine**—i.e., the system can generate “exceptional” items through standardized processing.

They are **not one of the numbered news-selector types** such as conflict, norm violation, or proximity. They operate one level above them.

| Layer | Role |
|---|---|
| **Selector types** | Semantic or programmatic criteria that make certain kinds of content more selectable as news. |
| **Routines** | Organizational procedures that stabilize and reproduce selection under constraints such as time, space, staffing, and format. |
...
That last point also has a real-world institutional footing. Recent reporting from the Brennan Center argues that nontransparent political spending (“dark money”) in U.S. federal races reached a record level in the 2024 cycle, describing it as a major increase over prior cycles. And a 2025 WIRED investigation reported on a politically aligned, donor-obscured initiative that allegedly offered influencers monthly payments while requiring secrecy and imposing content-related restrictions—an example of how “influencer” can operate as an organizational role in a propaganda supply chain rather than just an individual media persona.

Luhmann already emphasizes recursion: media select events, then select reactions to those selections (opinions-about-opinions, scandals-about-scandals). Platforms intensify this because the system can run tight feedback loops: content is tested on micro-audiences, metrics decide scaling, creators adapt to metrics, the algorithm adapts to creator adaptation, and then external funders adapt to both. Recent theory and audit work on engagement-based ranking explicitly models / measures these feedback loops and their tradeoffs. A Concrete operationalization today:

* **audit the selectors** (what signals predict reach?) with algorithmic audits and sock-puppet methods (common in current research on political exposure and ranking bias)
...
**Dark/opaque funding** creates *capacity* to manufacture attention at scale: paying creators, buying ads, hiring growth shops, running sockpuppet networks, subsidizing production, funding “issue orgs,” etc. The scale of nontransparent election spending has grown sharply in recent cycles, which matters because it buys repeated runs through the loop. **The typical move in influencer campaigns** is to pay for political messaging while minimizing disclosure (“keep it quiet”), which operationally means you’re buying *routines* (posting schedules, scripts, content restrictions, reporting) rather than buying one-off “speech.”

#### Goal-Setting and Audience Modeling
...
#### Content Manufacturing and Packaging
...
#### Seeding and Initial Distribution: The Test Phase
...
#### Legitimacy Laundering: Turning Platform Signal into Public Reality
...
Elizabeth Dubois’s *Influencers and Elections* report (with Louise Stahl) is almost *made* for the Luhmann move we’ve been doing: treat platforms as **selection infrastructures**, and treat influencers as **institutionalized “roles” inside that infrastructure** rather than as random individuals. Below is a way to *splice Dubois/Stahl directly into Luhmann*: **roles → routines → selectors → “cases” → feedback loops**, tuned specifically to TikTok and X.

| Analytical layer | Question | Influencer-era form |
|---|---|---|
| **Roles** | What function is the influencer performing? | Advertiser, endorser, volunteer, media outlet, data broker, journalist, or lobbyist. |
| **Routines** | What repeated practices produce the communication? | Briefs, scripts, posting schedules, cross-posting, targeting, disclosure choices, and performance reporting. |
| **Selectors** | What makes the content likely to be trusted or distributed? | Parasocial trust, niche fit, retention, engagement, personalization, conflict, and identity proximity. |
| **Cases** | What communicable object is produced? | Events, scandals, reactions, explainers, and meme-ready takes. |
| **Feedback** | How does performance reshape the next round? | Metrics guide creative iteration, creator recruitment, targeting, and further role-blurring. |


#### Influencers as Role Bundles

Dubois and Stahl’s key contribution, framed in Luhmannian terms, is the idea that influencers are not simply “ads with faces,” but rather **role bundles** operating across multiple positions in the political communication system. They argue that influencers play **multiple political roles** in elections, some directly connected to campaigns and others functioning more independently, which broadens how we should understand their political significance. In the lab’s summary materials, these roles include **advertisers**, **celebrity endorsers**, **campaign volunteers**, **media outlets**, **data brokers**, **journalists**, and **lobbyists**.
...
#### Opaque Funding Buys Routines, Not Just Speech

A core point in the report’s ecosystem framing is that influencers can be used to **circumvent ad transparency and spending rules**, including through **undisclosed partnerships financed by third parties**. Outside summaries of the report also emphasize that we often do not know **whether or how creators are being paid**, or how closely they may be tied to partisan groups. That lack of visibility is exactly the kind of **opacity** at issue here, because it makes it harder to determine who is shaping political communication and under what Incentives.
...
#### How Routines Manufacture Cases
...
#### A Platform-Native Selector Map
...
→ buy or coordinate with influencers in specific roles (advertiser/endorser/volunteer/media outlet/data broker/journalist/lobbyist)
→ **Routines:** briefs, scripts, posting calendars, cross-posting, comment management, disclosure ambiguity, microtargeting strategies; payments routed through third parties/off-platform
→ **Selectors exploited:** trust + niche-fit + engagement/retention + personalization + moralization/conflict + identity proximity
...
5. Connecting to diffusion of misinformation through networks
  ...
  Diffusion research consistently shows that misinformation spread depends on **network structure, superspreaders, and platform recommender systems**, not just on whether a claim is inherently “believable.” For example, research on recommender systems’ role in diffusion highlights how certain recommendation approaches—especially popularity-based and network-based systems—can become major drivers of how misinformation travels across platforms. Likewise, classic cascade studies show that polarized communities can sustain distinct narratives with different cascade dynamics, meaning that diffusion patterns themselves can vary systematically across ideological or social groupings.
...
- [San Francisco Chronicle](https://www.sfchronicle.com/super-bowl-lx/article/kid-rock-backlash-underage-21341430.php?) — Kid Rock backlash erupts as 'I like 'em underage' lyric resurfaces before Super Bowl
- [The Guardian](https://www.theguardian.com/us-news/2026/feb/08/bad-bunny-super-bowl-trump-maga?) — Bad Bunny to meet political moment as Maga fumes over Super Bowl show
- [Department of Justice](https://www.justice.gov/usao-pr/pr/fema-deputy-regional-administrator-former-president-cobra-acquisitions-llc-and-another?) — FEMA Deputy Regional Administrator, Former President Of ...
- [Office of Inspector General](https://www.hudoig.gov/sites/default/files/2021-04/HUD%20OIG%20Final%20Report_2019SU008945I.pdf?) — Review of HUD's Disbursement of Grant Funds ...
- [U.S. Government Accountability Office](https://www.gao.gov/assets/gao-24-105557.pdf?) — GAO-24-105557, PUERTO RICO DISASTERS
- [EW.com](https://ew.com/donald-trump-bad-bunny-super-bowl-half-time-show-reaction-11900922?) — Donald Trump blasts Bad Bunny's Super Bowl 2026 halftime show: 'An affront to the Greatness of America'
- [KOMO](https://komonews.com/news/nation-world/turning-point-usa-all-american-halftime-show-conservative-halftime-show-alternative-family-friendly-halftime-concert-turning-point-usa-cultural-initiative-charlie-kirk-halftime-show-criticism-andrew-kolvet-interview?) — Turning Point USA launches 'All-American Halftime Show ...
- [Awful Announcing](https://awfulannouncing.com/nfl/tpusa-all-american-halftime-show-kid-rock-americana-religion-family-friendly.html?) — TPUSA All-American Halftime Show featured Americana ...
- [Center for an Informed Public](https://www.cip.uw.edu/2021/05/26/participatory-disinformation-kate-starbird/?) — What is participatory disinformation?
- [edoc.coe.int](https://edoc.coe.int/en/media/7495-information-disorder-toward-an-interdisciplinary-framework-for-research-and-policy-making.html?) — Information disorder: Toward an interdisciplinary framework ...
- [demtech.oii.ox.ac.uk](https://demtech.oii.ox.ac.uk/wp-content/uploads/sites/12/2018/07/ct2018.pdf?) — A Global Inventory of Organized Social Media Manipulation
- [OUP Academic](https://academic.oup.com/book/26406?) — Network Propaganda: Manipulation, Disinformation, and ...
- [YouTube](https://www.youtube.com/watch?v=03UCXMUM3uc&) — Mis- and Disinformation During Crisis Events with Kate Starbird
- [navigator.oii.ox.ac.uk](https://navigator.oii.ox.ac.uk/what-is-comprop/?) — What is Computational Propaganda? - DemTech Navigator
- [The Guardian](https://www.theguardian.com/world/article/2024/jun/24/israel-fund-us-university-protest-gaza-antisemitism?) — Israeli documents show expansive government effort to shape US discourse around Gaza war
- [Middle East Monitor](https://www.middleeastmonitor.com/20240717-israeli-ministry-funding-multi-million-dollar-disinformation-campaign-spreading-islamophobia/?) — Israeli ministry funding multi-million-dollar disinformation ...
- [Axios](https://www.axios.com/2026/02/04/trump-alex-pretti-shooting-americans-investigation?) — Most Americans concerned over Trump admin's handling of Alex Pretti shooting
- [People.com](https://people.com/alex-pretti-s-cause-of-death-revealed-as-medical-examiner-rules-death-homicide-11898096?) — Alex Pretti's Cause of Death Revealed as Medical Examiner Rules Death a Homicide
- [opb](https://www.opb.org/article/2026/01/29/internal-review-contradicts-white-house-narrative-of-prettis-death/?) — Internal review contradicts White House narrative of Pretti's ...
- [New York Post](https://nypost.com/2026/02/04/us-news/jd-vance-wont-apologize-for-alex-pretti-minneapolis-shooting-calling-icu-nurse-would-be-assassin/?) — JD Vance won't apologize for spreading claim Alex Pretti was would-be 'assassin'
- [Reuters](https://www.reuters.com/legal/government/us-justice-dept-opens-civil-rights-probe-into-alex-pretti-shooting-official-says-2026-01-30/?) — US Justice Dept opens civil rights probe into Alex Pretti shooting, official says
- [ABC News](https://abcnews.go.com/Politics/minute-minute-timeline-fatal-shooting-alex-pretti-federal/story?id=129547199&) — A minute-by-minute timeline of the fatal shooting of Alex Pretti ...
- [AP News](https://apnews.com/article/65a963816603a08bbc9db83961dd173f?) — The Justice Department has opened a federal civil rights probe into the killing of Alex Pretti
- [Reuters](https://www.reuters.com/legal/government/us-review-alex-pretti-killing-does-not-mention-him-brandishing-firearm-2026-01-28/?) — US review of Alex Pretti killing does not mention him ...
- [Reuters](https://www.reuters.com/fact-check/verified-footage-showing-alex-prettis-death-edited-alter-object-hand-2026-01-27/?) — Verified footage showing Alex Pretti's death edited to alter ...
- [Axios](https://www.axios.com/2026/02/04/minnesota-killings-investigation-pretti-good?) — Exclusive: 300+ ex-DOJ lawyers demand transparent Minnesota shooting probes
- [citap.unc.edu](https://citap.unc.edu/news/local-news-platforms-mis-disinformation/?) — Addressing the decline of local news, rise of platforms, and ...
- [Reuters](https://www.reuters.com/world/justice-department-unit-police-misconduct-sees-staffing-plunge-probes-scaled-2026-02-05/?) — Justice Department unit on police misconduct sees staffing plunge and probes scaled back, sources say
- [Knight First Amendment Institute](https://knightcolumbia.org/content/engagement-user-satisfaction-and-the-amplification-of-divisive-content-on-social-media?) — Engagement, User Satisfaction, and the Amplification of ...
- [ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S0176268022000623?) — Social media networks, fake news, and polarization
- [ACM Digital Library](https://dl.acm.org/doi/10.1145/3579616?) — How Participatory Disinformation Shaped Deep Stories to ...
- [arXiv](https://arxiv.org/html/2411.14652v1?) — Social Media Algorithms Can Shape Affective Polarization ...
- [Nature](https://www.nature.com/articles/s41599-025-06277-7?) — Drawing digital lines: pattern analysis of divisive rhetoric in ...
- [OUP Academic](https://academic.oup.com/anncom/article/45/3/188/7912664?) — Role of (Social) Media in Political Polarization: A Systematic ...
- [Cambridge University Press & Assessment](https://www.cambridge.org/core/journals/episteme/article/echo-chambers-and-epistemic-bubbles/5D4AC3A808C538E17C50A7C09EC706F0?) — ECHO CHAMBERS AND EPISTEMIC BUBBLES
- [PhilPapers](https://philpapers.org/rec/BEGEP-2?) — Evidential Preemption - Endre Begby
- [Aeon](https://aeon.co/essays/why-its-as-hard-to-escape-an-echo-chamber-as-it-is-to-flee-a-cult?) — Why it's as hard to escape an echo chamber ...
- [endrebegby.synthasite.com](https://endrebegby.synthasite.com/resources/Evidential%20Preemption%2C%20web%20draft.pdf?) — Evidential Preemption
- [dissent.is](https://dissent.is/wp-content/uploads/sites/2/2025/11/massenmedienrealitaetluhmann.pdf) — Die Realität der Massenmedien
- [unisalento.it](https://www.unisalento.it/documents/20152/2157613/LUHMANN-What-is-Communication.pdf/) — What is communication
- [dissent.is](https://dissent.is/wp-content/uploads/sites/2/2025/11/massenmedienrealitaetluhmann.pdf?) — Die Realität der Massenmedien - Niklas Luhmann
- [GRIN](https://www.grin.com/document/97439?srsltid=AfmBOopsihVzcdbgb1yDUkleqyBDiDw9NbdJCz48E12QLfJW7Z0-Cm6U&) — Die Realität der Massenmedien. Die Funktionsweise ...
- [OUP Academic](https://academic.oup.com/pnasnexus/article/4/3/pgaf062/8052060?) — Engagement, user satisfaction, and the amplification of ...
- [Brennan Center for Justice](https://www.brennancenter.org/our-work/research-reports/dark-money-hit-record-high-19-billion-2024-federal-races?) — Dark Money Hit a Record High of $1.9 Billion in 2024 ...
- [WIRED](https://www.wired.com/story/dark-money-group-secret-funding-democrat-influencers/?) — A Dark Money Group Is Secretly Funding High-Profile ...
- [SSRN](https://papers.ssrn.com/sol3/Delivery.cfm/4f79d5ca-867d-49db-a4ba-ebfdcaf0ac9b-MECA.pdf?abstractid=5316506&mirid=1&) — Ranking for Engagement: How Social Media Algorithms ...
- [facctconference.org](https://facctconference.org/static/docs/facct2025-206archivalpdfs/facct2025-final1290-acmpaginated.pdf?) — Auditing Political Exposure Bias: Algorithmic Amplification ...
- [GitHub](https://github.com/twitter/the-algorithm?) — Source code for the X Recommendation Algorithm
- [The Verge](https://www.theverge.com/policy/874746/tiktok-addictive-eu-regulators-infinite-scroll-notifications-autoplay?) — TikTok's infinite scroll is too addictive, say EU regulators
- [PolCommTech.ca](https://www.polcommtech.com/research/influencers-and-elections) — Influencers and Elections |  PolCommTech.ca
- [University of Ottawa](https://www.uottawa.ca/en/news-all/new-report-examining-impact-influencers-elections) — A new report examining the impact of influencers on elections | University of Ottawa
- [BC FIPA](https://fipa.bc.ca/wp-content/uploads/2025/07/20250725-FIPA-Submission-Democratic-and-Electoral-Reform-FINAL.pdf?) — Submission to the Special Committee on Democratic and ...
- [University of Ottawa](https://www.uottawa.ca/research-innovation/news-all/new-report-examining-impact-influencers-elections) — A new report examining the impact of influencers on elections | Research and innovation
- [Media Manipulation Casebook](https://mediamanipulation.org/definitions/distributed-amplification/?) — Distributed amplification
- [Vox](https://www.vox.com/policy-and-politics/2020/1/16/20991816/impeachment-trial-trump-bannon-misinformation?) — “Flood the zone with shit”: How misinformation overwhelmed ...
- [online.umich.edu](https://online.umich.edu/teach-outs/disinformation-misinformation-and-fake-news-teach-out/lessons/4d-model-disinformation-campaigns/?) — Disinformation, Misinformation, and Fake News Teach-Out
- [ACM Digital Library](https://dl.acm.org/doi/10.1145/3616088?) — Understanding the Contribution of Recommendation ...
- [PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC4725489/?) — The spreading of misinformation online - PMC
